...
---------------------------------------------------------------------------*/
		...
		$var_form2 = "
				...
				<b class='css_form_text'>&nbsp;$lang_name $var_mandatory_char</b><br/>
				<input class=' css_form_namefield' style='color:black; font-size:12px;' type='text' name='gbname' value='$gbname' maxlength='50' />
				</div>

				<!-- email field -->
				<div class='css_form_textfieldspace'>
				<b class='css_form_text '>&nbsp;$lang_email $var_mandatory_email</b><br/>
				<input class='css_form_emailfield ' style='color:black; font-size:12px;'type='text' name='gbemail' value='$gbemail' />
				</div>
				";
		...
		$var_form3 = "
				...
				<div class='css_form_textfieldspace'>
				<b class='css_form_text '>&nbsp;Gravatar $lang_email <a href='http://en.gravatar.com/' target='_blank'>[?]</a></b><br/>
				<input class='css_form_emailfield ' style='color:black; font-size:12px; 'type='text' name='gbgravataremail' value='$gbgravataremail' />
				</div>
				";
		...
		$var_form4 = "
				<!-- url field -->
				<div class='css_form_textfieldspace'>
				<!-- <b class='css_form_text '>&nbsp;$lang_url $var_mandatory_url</b><br/> -->
				<input class='css_form_urlfield ' style='color:black; font-size:12px;' type='hidden' name='gburl' value='$gburl' />
				</div>
				";
		...
		$var_form5 = "
				...
				<div class='css_form_textfieldspace'>
				<b class='css_form_text '>&nbsp;$var_additional_option_title</b>
				<select class='css_form_additional_option ' style='color:black; font-size:12px;' name='gbadditional'>
		...
		$var_form6 = "
				...
				$countchars[3]
				$countchars[1]
				<b class='css_form_text '>&nbsp;$lang_message $var_mandatory_char</b><br/>
				<textarea class='css_form_messagefield ' style='color:black; font-size:12px;' name='gbmsg' rows='0' cols='0' $countchars[0]>$gbmsg</textarea>
				</div>
		...
		$var_form7 = "
				...
				<div class='css_form_antispamcontent_position'>
				<input class='css_form_antispam_inputfield ' style='color:black; font-size:12px;' type='text' name='securecode' /></div>
				";
		...
		$var_form8 = "
				...
				<div class='css_form_antispamtext'>$lang_antispam</div>
				$captcha2 <input class='css_form_antispam_inputfield ' style='color:black; font-size:12px;' type='text' name='securecode' />
				";
		...
		$var_form9 = "
				<!-- submit button -->
				<div class='css_form_submit_position'><input class='css_form_submit ' style='color:black; font-size:12px;' type='submit' value='$lang_submit' /></div>
				";
